...
const SkillsUpgradeHero = () => (
  <section id="home" className="relative min-h-[90vh] pt-20 flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-600 via-emerald-600 to-teal-700">
    {/* Background Pattern */}
    ...
    <div className="relative z-10 px-6 py-10 max-w-4xl text-center">
      <h1 className="mt-10 mb-6 text-4xl font-extrabold leading-tight text-white drop-shadow-xl lg:text-6xl">
        Skills Upgrade<br className="hidden lg:block" /> Elevate Your Career
      </h1>
      <p className="mx-auto mb-8 max-w-3xl text-2xl font-medium leading-relaxed text-white/90">
        Transform your professional future with industry-relevant skills, certifications, and training programs designed for career advancement.
      </p>
...
export default SkillsUpgradeHero;
